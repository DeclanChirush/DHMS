...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a class="" href="/categories"><em
					class="fa fa-navicon"></em> Categories</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li>Dashboard</li>
				<li class="active">Transaction Categories</li>
			</ol>
		</div>
		<!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Transaction Categories</h1>
			</div>
		</div>
		<!--/.row-->
