...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-4 mx-auto mt-5">
                ...
                <input type="hidden" th:field="*{supplier_id}" />
                    <fieldset>
                      <div id="legend">
                        <legend class="text-center">Update Supplier</legend>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="controls">
                          <button class="btn btn-secondary btn-block" type="submit" >Update Supplier</button>
                        </div>
                      </div>
