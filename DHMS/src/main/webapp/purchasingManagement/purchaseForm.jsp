...
<link
	href="/purchasingManagement/style/formStyle/vendor/mdi-font/css/material-design-iconic-font.min.css"
	rel="stylesheet" media="all">
<link
	href="/purchasingManagement/style/formStyle/vendor/font-awesome-4.7/css/font-awesome.min.css"
	rel="stylesheet" media="all">
...
<!-- Vendor CSS-->
<link
	href="/purchasingManagement/style/formStyle/vendor/select2/select2.min.css"
	rel="stylesheet" media="all">
<link
	href="/purchasingManagement/style/formStyle/vendor/datepicker/daterangepicker.css"
	rel="stylesheet" media="all">

<!-- Main CSS-->
<link href="/purchasingManagement/style/formStyle/css/main.css"
	rel="stylesheet" media="all">

<link href="https://fonts.googleapis.com/css?family=Poppins"
	rel="stylesheet" />
<link href="/purchasingManagement/style/searchBarStyle/css/main.css"
	rel="stylesheet" />
	
	<link href="/purchasingManagement/style/buttonStyle/button.css" rel = "stylesheet">
...
<body>
	...
	<script
		src="/purchasingManagement/style/searchBarStyle/js/extention/choices.js"></script>
	<script>
